        ...
        try {
            ...
            const bookingPromises = notificationsData.map(async (notification) => {
                if (notification.bookingId) {
                    try {
                        const bookingResponse = await api.get(`/booking/${notification.bookingId}`);
    ...
    const NotificationSkeleton = () => (
        <div className="d-flex align-items-start mt-1 p-0 gap-3 border-bottom">
            <div className="bg-light rounded d-flex align-items-center mt-2">
                <Placeholder as="div" animation="wave" style={{ width: 65, height: 65 }} />
            </div>
            <div className="w-100 mt-3">
                <div className="d-flex align-items-center justify-content-start gap-2">
                    <Placeholder as="span" animation="wave" style={{ width: 50, height: 24 }} />
                    <Placeholder as="small" animation="wave" style={{ width: 100, height: 14 }} />
                </div>
                <Placeholder as="p" animation="wave" style={{ width: '80%', height: 20 }} className="mt-2" />
                <Placeholder as="p" animation="wave" style={{ width: '100%', height: 16 }} className="mb-2" />
            </div>
        </div>
    );
